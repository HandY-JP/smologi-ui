...
export declare const COMPACT_THRESHOLD_PX = 24;
/**
 ...
 */
export declare const EXPAND_THRESHOLD_PX = 8;
export declare const INITIAL_COMPACTION_STATE: CompactionState;
/**
 ...
 */
export declare function nextCompactionState(state: CompactionState, scrollY: number): CompactionState;
/**
 ...
 */
export declare function resolveScrollTop(scroller: {
    scrollTop: number;
} | null | undefined, fallbackScrollY: number): number;
/** 最後に見た工程（stage）を覚える localStorage キー。ページ・ユーザー単位で分ける。 */
export declare function topbarStageStorageKey(pageKey: string, userId?: string | null): string;
 ...
 */
export declare function computeChipOverflow(chips: OverflowChip[], availablePx: number, moreChipWidthPx: number): ChipOverflowResult;
//# sourceMappingURL=topbar-compaction.d.ts.map